...
struct ReverbFx : Module{
	...
	ReverbFx() {
		...
		configParam(ReverbFx::DECAY_PARAM, 0.0f, 0.9f, 0.5f, "Decay");
		configParam(ReverbFx::DAMP_PARAM, 0.0f, 1.0f, 0.0f, "Damp");
		configParam(ReverbFx::BLEND_PARAM, 0.0f, 1.0f, 0.5f, "Blend");
